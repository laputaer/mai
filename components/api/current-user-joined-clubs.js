...
/**
 * current-user-joined-clubs.js
 *
 * API for getting clubs joined by current user, excluding clubs owned by this user
 */
...
function *middleware(next) {
	...
	// STEP 2: get clubs
	var owned_clubs = yield clubsDomain.getUserJoinedClubs({
		db: this.db
